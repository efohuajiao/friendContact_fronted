<template>
    ...
    <van-tab>
      ...
      >
        ...
        >
          <template #bottom>
            <span
              >队伍人数：{{ teamList.currentNum }} / {{ teamList.maxNum }}</span
            ><br />
          ...
          <template #footer>
            ...
            <van-button
              size="mini"
              @click="toJoinTeam(teamList.id)"
              v-if="!teamList.isExist"
              >加入队伍</van-button
            >
            <van-button size="mini" @click="searchTeamInfo(teamList.id)"
              >查看队伍</van-button
            >
          </template>
        </van-card>
      ...
      >
        ...
        >
          ...
          <template #footer>
            <van-button
              size="mini"
              @click="toJoinTeam(teamList.id, teamList.status)"
              v-if="!teamList.isExist"
              >加入队伍</van-button
            >
            <van-button size="mini" @click="searchTeamInfo(teamList.id)"
  ...
  <van-dialog
    ...
    title="请输入队伍密码"
    show-cancel-button
    @confirm="joinPrivateTeam(teamId)"
  >
    <input
      type="password"
      class="pwd"
      v-model.number="teamPwd"
      placeholder="请输入密码"
    />
  </van-dialog>
</template>
